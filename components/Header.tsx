  ...
  return (
    <header className="bg-white flex justify-center max-sm:p-3 p-8 shadow-[0_25px_64px_-40px_rgba(0,0,0,0.2)]">
      ...
      <div className="flex w-full max-sm:flex-col max-sm:gap-1 justify-between gap-6 items-center max-w-[1160px]">
        ...
        <div className="max-sm:hidden flex flex-1 justify-around gap-4 items-center">
        ...
        <div className="flex flex-1 max-sm:gap-4 w-full gap-8">
          <input type="text" placeholder="Search" className="flex flex-1 max-w-[600px] border border-gray-400 rounded-lg p-1" />
