...
export function Header() {
  return (
    <header className="fixed w-full bg-background-50 flex flex-col justify-center ">
      <div className="flex flex-1 mx-auto w-full justify-between max-sm:flex-col max-sm:gap-1  gap-6 items-center max-w-[1200px] max-sm:p-3 p-5">
        ...
        <div className="flex flex-1 w-full justify-end items-center max-sm:justify-between">
          <div className=" relative flex w-full max-h-12 mr-7 rounded-lg text-detailsPrimary-100 max-w-[600px] bg-detailsPrimary-100/10 max-sm:mr-4 flex-1 ">
